...
class TestAbsLoss(unittest.TestCase):
    ...
    def test_abs_loss_invalid_n(self):
        ...
        # call the `abs_loss` function
        t.call("abs_loss")
        # generate the `assembly/TestAbsLoss_test_abs_loss_invalid_n.s` file and run it through venus
        t.execute(code=36)
...
class TestSquaredLoss(unittest.TestCase):
    ...
    def test_squaredloss_invalid_n(self):
        ...
        # call the `squared_loss` function
        t.call("squared_loss")
        # generate the `assembly/TestAbsLoss_test_squaredloss_invalid_n.s` file and run it through venus
        t.execute(code=36)
...
class TestZeroOneLoss(unittest.TestCase):
    ...
    def test_zerooneloss_invalid_n(self):
        ...
        # call the `zero_one_loss` function
        t.call("zero_one_loss")
        # generate the `assembly/TestAbsLoss_test_zero_one_loss_invalid_n.s` file and run it through venus
        t.execute(code=36)
...
class TestInitializeZero(unittest.TestCase):
    ...
    def test_initialize_zero_invalid_n(self):
        ...
        # call the `zero_one_loss` function
        t.call("initialize_zero")
        # generate the `assembly/TestAbsLoss_test_zero_initialize_zero_invalid_n.s` file and run it through venus
        t.execute(code=36)
